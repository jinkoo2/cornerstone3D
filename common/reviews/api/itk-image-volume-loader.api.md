## API Report File for "@jinkoo2/itk-image-volume-loader"
...
// @public (undocumented)
export class ItkImageVolume extends ImageVolume {
    constructor(imageVolumeProperties: Types.IVolume);
    // (undocumented)
...
// @public (undocumented)
export function itkImageVolumeLoader(volumeId: string, options: {}): IVolumeLoader;
