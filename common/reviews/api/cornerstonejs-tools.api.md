## API Report File for "@jinkoo2/cornerstonejs-tools"
...
// @public (undocumented)
export class CubeROIDisplayTool extends AnnotationDisplayTool {
    constructor(toolProps?: PublicToolProps, defaultToolProps?: ToolProps);
    // (undocumented)
    ...
    // (undocumented)
    _getFirstRenderEngine(): Types_2.IRenderingEngine;
    // (undocumented)
    _getFirstViewport(): Types_2.IViewport;
    // (undocumented)
    _getImageData(): any;
    // (undocumented)
    ...
    // (undocumented)
    _isAxialVolumeViewport(viewport: any): boolean;
    // (undocumented)
    _isCoronalVolumeViewport(viewport: any): boolean;
    // (undocumented)
    isDrawing: boolean;
    // (undocumented)
    _isInsideVolume: (index1: any, index2: any, dimensions: any) => boolean;
    // (undocumented)
    _isSagittalVolumeViewport(viewport: any): boolean;
    // (undocumented)
    renderAnnotation: (enabledElement: Types_2.IEnabledElement, svgDrawingHelper: SVGDrawingHelper) => boolean;
    // (undocumented)
